...
const TREND_BASE: Record<string, number[]> = {
  "P3300 Titan": [6200, 6500, 6800, 6400, 7000, 6700, 6800],
  "P2500 Atlas": [5800, 1400, 1300, 1200, 1100, 1200, 1200],
  "P1800 Vulcan": [4500, 4700, 4900, 4600, 5100, 4800, 4900],
  "P1460 Hermes": [3400, 3600, 3800, 3700, 3900, 3700, 3800],
  "P1100 Swift": [1500, 1600, 1700, 1600, 1750, 1650, 1700],
};
